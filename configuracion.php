...
if ($_FILES) {
    $archivo=$_FILES;
    $msg=grabaImagen($archivo);
}


//para el cambio de contrasena
if(isset($_POST['password'])&& isset($_POST['repite_password'])){
    $password=strip_tags($_POST['password']);
    $repite_password=strip_tags($_POST['repite_password']);
    $msg2 .= cambiarContrasena($password,$repite_password);
}
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">SUBIR FOTO DE PERFIL</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="configuracion.php" method="POST" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="exampleInputFile">SUBIR FOTO</label>
                                        <input name="archivo" type="file" id="exampleInputFile">
                                        <p class="help-block">sube tu mejor foto.</p>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="configuracion.php" method="POST">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="repite_password" type="password" class="form-control"
                                            id="exampleInputPassword1" placeholder="Password">
                                    </div>
